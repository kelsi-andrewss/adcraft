...
VISUAL_RUBRICS: dict[str, str] = {
    "brand_consistency": (
        "BRAND CONSISTENCY "
        "-- Does the image visually align with the Varsity Tutors brand?\n"
        "\n"
        "Varsity Tutors brand visual identity: navy (#003057), teal\n"
        "(#00B4D8), warm white backgrounds, clean sans-serif typography.\n"
        "Visual tone is empowering, knowledgeable, and approachable.\n"
        "Imagery features confident students, supportive tutors, and\n"
        "bright learning environments.\n"
        "\n"
        "Criteria:\n"
        "- Color palette adherence (navy, teal, warm white -- not neon,\n"
        "  not dark/moody)\n"
        "- Typography style (clean, modern sans-serif -- not decorative,\n"
        "  not handwritten)\n"
        "- Visual tone (empowering, approachable -- not clinical, not\n"
        "  chaotic, not fear-based)\n"
        "- Brand recognizability (could this be identified as a Varsity\n"
        "  Tutors ad?)\n"
        "\n"
        "1-3 (Poor): Generic stock photo with clashing color palette.\n"
        "  No brand signals whatsoever. Neon colors, dark moody tones,\n"
        "  or overly corporate sterile look. Could belong to any company.\n"
        "  The image actively damages brand perception if used in a VT ad.\n"
        "\n"
        "4-6 (Adequate): Neutral palette that doesn't clash but isn't\n"
        "  distinctly VT. Generic educational imagery (chalkboard, books)\n"
        "  without brand-specific visual language. Inoffensive but\n"
        "  forgettable. A viewer wouldn't associate this with Varsity\n"
        "  Tutors specifically.\n"
        "\n"
        "7-8 (Strong): Clear brand alignment -- navy/teal palette present,\n"
        "  clean layout, warm tone. Image features confident students or\n"
        "  supportive learning moments. Professional and polished.\n"
        "  Recognizably educational and on-brand, though not uniquely VT.\n"
        "\n"
        "9-10 (Exceptional): Distinctly Varsity Tutors. Navy/teal palette\n"
        "  dominates, typography is clean and modern, visual tone is\n"
        "  perfectly empowering and approachable. Image could only belong\n"
        "  to VT. Builds brand equity with every impression.\n"
        "\n"
...
VISUAL_FEW_SHOT_EXAMPLES: dict[str, str] = {
    "brand_consistency": (
        ...
        "clean desk with a laptop, navy blue wall behind them with subtle\n"
        "teal accent stripe. Warm natural lighting from the left. Student\n"
        "is smiling while reviewing notes. Clean sans-serif watermark in\n"
        "bottom corner. Color palette is predominantly navy, white, and\n"
        "teal. Modern, professional feel.\n"
        "Rationale: Strong brand alignment -- the navy/teal palette is\n"
        "immediately recognizable as Varsity Tutors. Clean composition\n"
        "with warm lighting matches the approachable, empowering brand\n"
        "tone. The confident student embodies VT's supportive positioning.\n"
        "Only misses a 9 because the teal accent is subtle and the overall\n"
        ...
        "yellow -- no navy or teal. The mood is institutional and\n"
        "impersonal.\n"
        "Rationale: Zero brand alignment. The color palette clashes\n"
        "entirely with VT's navy/teal/white identity. Fluorescent lighting\n"
        "and disengaged students convey the opposite of VT's empowering,\n"
        "approachable tone. The neon text overlay is off-brand typography.\n"
        "This image would damage brand perception if used in a VT ad.\n"
        "Score: 3"
    ),
    "composition_quality": (
        "Example 1 (Score: 9):\n"
...
VISUAL_SINGLE_DIMENSION_PROMPT = (
    ...
    "creative for Varsity Tutors, a leading online tutoring platform.\n"
    "\n"
